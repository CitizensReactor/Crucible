...
namespace DataCore2
{
    ...
    {
        internal class WeakPointerArrayFixup : ArrayFixupBase
        {
            internal WeakPointerArrayFixup(DataCoreDatabase database, object instance, PropertyInfo info, int firstIndex, int arrayCount)
            ...
            public override void Run()
            {
                ...
                var pointerValues = BinaryBlobReader.FastCopySafe(Database.RawDatabase.weakValues, FirstIndex, ArrayCount);
